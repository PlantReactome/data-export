...
public class EWAS_2_Pathway_Human extends DataExportAbstract {
    ...
    public String getQuery() {
        return " MATCH (ewas:EntityWithAccessionedSequence)<-[:input|output|catalystActivity|physicalEntity|regulatedBy|regulator|hasComponent|hasMember|hasCandidate|repeatedUnit*]-(rle:ReactionLikeEvent)<-[:hasEvent]-(p:Pathway{speciesName:\"Oryza sativa\"})" +
                "WITH ewas, p " +
